...
public class BlackjackDemo extends Application {
   ...
   public void start(Stage primaryStage){   
      ...
      */
      ...
      //Sound win
      //clip = new AudioClip("https://www.youtube.com/watch?v=qj3o9jvUc8c");
      //String s="Para Kazanma Sesi.m4a";
      //sound = new Media(new File(s).toURI().toString());
      //m1 = new MediaPlayer(sound);
      //m1.play();
      //Sound lost
      //String s1="";
      //Media sound1 = new Media(new File(s1).toURI().toString());
      //m2 = new MediaPlayer(sound1);
  ...
  */
  ...
  public void endRound(int over) {
     ...
     //You tied the dealer
     if(over == 0) {
        after.setText("Tie. $"+wager+" returned to your stack");
